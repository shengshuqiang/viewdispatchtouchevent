 ...
 */
public class ProxyLinearLayout extends LinearLayout {
    public ProxyLinearLayout(Context context) {
        super(context);
    }

    public ProxyLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
